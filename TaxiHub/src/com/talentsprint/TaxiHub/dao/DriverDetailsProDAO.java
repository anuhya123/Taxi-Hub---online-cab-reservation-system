...
public class DriverDetailsProDAO {
	...
	public String getDriverEmailBasic(String status) throws SQLException {
		String email = null;
		String sql = "select email from driver where registration_num in (select registration_num from vehicle where status = ? and cost_per_km = 8)";
	...
	public String retrieveCabDriver(String status) throws SQLException {
		String driver = null;
		String sql =  "select driver_name from driver where registration_num in (select registration_num from vehicle where status = ? and cost_per_km = 8)";
	...
	public String retrieveDriverPhone(String status) throws SQLException {
		String phone = null;
		String sql =  "select driver_phone_num from driver where registration_num in (select registration_num from vehicle where status = ? and cost_per_km = 8)";
		PreparedStatement statement = conn.prepareStatement(sql);
		statement.setString(1, status);
		ResultSet resultSet = statement.executeQuery();
		while (resultSet.next()) {
	...
	public String retrieveCabNumber(String status) throws SQLException {
		String cabNum = null;
		String sql =  "select registration_num from vehicle where status = ? and cost_per_km = 8";
		PreparedStatement statement = conn.prepareStatement(sql);
		statement.setString(1, status);
		ResultSet resultSet = statement.executeQuery();
		while (resultSet.next()) {
	...
	public int retrieveDriverId(String status) throws SQLException {
		int did = 0;
		String sql =  "select driver_id from driver where registration_num in (select registration_num from vehicle where status = ? and cost_per_km = 8)";
		PreparedStatement statement = conn.prepareStatement(sql);
		statement.setString(1, status);
		ResultSet resultSet = statement.executeQuery();
		while (resultSet.next()) {
